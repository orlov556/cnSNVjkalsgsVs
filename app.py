...
# Остальной код административных функций (статистика, курсы, кошельки, комиссия и т.д.) остается без изменений...
# Для краткости я не включаю их сюда, но они должны быть добавлены из предыдущей версии
